class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) << [:uid, :provider, :sign_up_ip, profile_attributes: [:id, :first_name, :last_name, :birthday, :gender, :postcode, :about_me, :profile_picture, :nonprofit, :referrer, :city, :state, :neighborhood]]
